...
![AI domains](images/ai_domains.png)  
...
- **[neural-networks/](neural-networks/)** - Neural networks from scratch: sigmoid neurons, backpropagation, gradient descent visualizations
